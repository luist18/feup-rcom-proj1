...
EMITTER_FILES = $(SRC_DIR)/emitter/emitter.c $(SRC_DIR)/data_link/packet/packet_dl.c $(SRC_DIR)/data_link/control/control.c $(SRC_DIR)/data_link/data_link.c $(SRC_DIR)/app_layer/packet/packet_al.c $(SRC_DIR)/app_layer/app_layer.c $(SRC_DIR)/util/flags.h $(SRC_DIR)/util/file.c $(SRC_DIR)/util/util.c
