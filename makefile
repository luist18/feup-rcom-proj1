...
EMITTER_FILES = $(SRC_DIR)/emitter/emitter.c $(SRC_DIR)/packet/packet.c $(SRC_DIR)/control/control.c $(SRC_DIR)/protocol/protocol.c $(SRC_DIR)/util/flags.h
RECEPTOR_FILES = $(SRC_DIR)/receptor/receptor.c $(SRC_DIR)/packet/packet.c $(SRC_DIR)/util/flags.h
