...
EMITTER_FILES = $(SRC_DIR)/emitter/emitter.c $(SRC_DIR)/data_link/packet/packet_dl.c $(SRC_DIR)/data_link/control/control.c $(SRC_DIR)/data_link/data_link.c $(SRC_DIR)/app_layer/packet/packet_al.c $(SRC_DIR)/util/flags.h
